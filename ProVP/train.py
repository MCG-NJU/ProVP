...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.PROVP = CN()
    cfg.TRAINER.PROVP.PL = 16
    ...
    cfg.LOSS.T = 1.
    cfg.LOSS.LAMBDA = 1.
    cfg.OPTIM.USE_REF = False
    cfg.OPTIM.LR_TEXT = 0.
    cfg.OPTIM.LR_VISUAL = 0.
    cfg.TRAINER.COOP.TEXT_NCTX = 2
    cfg.TRAINER.COOP.VISUAL_NCTX = 8
    cfg.TRAINER.COOP.VISUAL_LAYER = 9
    cfg.TRAINER.COOP.TEXT_LAYER = 10
    cfg.MODEL.PATH = ""
    cfg.TRAINER.best_acc = 0.0
...
def main(args):
    print("gpu num is ", torch.cuda.device_count())
    cfg = setup_cfg(args)
    if cfg.SEED >= 0:
